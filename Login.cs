...
namespace TasTrack
{
    public class Login
    {
        ...
        public Login()
        {
            ...
            if (GlobalVar.errorNumber == 0) { loginPrinter.oopsyDesc = "Oops! Please select a valid option."; }
            if (GlobalVar.errorNumber == 1) { loginPrinter.oopsyDesc = "I couldn't find that profile."; }
            if (GlobalVar.errorNumber == 2) { loginPrinter.oopsyDesc = "I'm sorry, the information you entered was invalid."; }
            if (GlobalVar.errorNumber == 3) { loginPrinter.oopsyDesc = "Your passwords do not match. Please try again."; }
            if (GlobalVar.errorNumber == 4) { loginPrinter.oopsyDesc = "You gotta enter a number before you can continue!"; }
            ...
            try
            {
                ...
                switch (select)
                {
                    case 1:
                        ...
                        string filename = GlobalVar.filePath.Split('\\').Last();
